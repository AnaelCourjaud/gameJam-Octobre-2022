...
void init(SDL_Window *window, SDL_Renderer *renderer, spriteBase_t *spritesDeBase[NBRTEXTURES], spriteCourant_t *listeCourants[tailleMaxSpritesCourants], perso_t *listePersos[NBRMAXPERSOS])
{
    ...
    char nomFichiers[NBRTEXTURES][tailleMaxFichiers] = {"./Sprites/ecranfin.png", "./Sprites/passerelleanimee.png", "./Sprites/batiment2.png", "./Sprites/batiment2coupe.png",
                                                         "./Sprites/fond1.png", "./Sprites/fond2.png", "./Sprites/fond3.png", "./Sprites/fondaccueil.png", "./Sprites/lore1.png",
                                                         "./Sprites/lore2.png", "./Sprites/lore3.png", "./Sprites/bugfirewalk.png", "./Sprites/bugfireattaque.png",
                                                         "./Sprites/bugfiremort.png", "./Sprites/flyvolant.png", "./Sprites/flyvolant.png", "./Sprites/flymort.png",
                                                         "./Sprites/mantiswalk.png", "./Sprites/mantiswalk.png", "./Sprites/mantismort.png", "./Sprites/robot.png",
                                                         "./Sprites/robotattaque.png", "./Sprites/robotmort.png", "./Sprites/robotmetal.png", "./Sprites/robotmetalattaquedeb.png",
                                                         "./Sprites/robotmetalmort.png", "./Sprites/robotpetitwalk.png", "./Sprites/robotpetitattaque.png", "./Sprites/robotpetitmort.png"};
    ...
    for (int i = 0; i < NBRTEXTURES; i++)
    {
        ...
        else if (i >= indiceBugfirewalk)
        {
            ...
            {
                spritesDeBase[i]->wCoefReductionDestination = 0.15;
                spritesDeBase[i]->hCoefReductionDestination = 0.20;
                spritesDeBase[i]->nbrImagesHorizontales = 4;
                spritesDeBase[i]->nbrImagesVerticales = 1;
                spritesDeBase[i]->ralenti = 2;
